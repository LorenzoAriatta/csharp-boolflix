...
namespace csharp_boolflix.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Duration,Type,CoverImage,Description")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Duration,Type,CoverImage,Description")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
